...
"  /db_recent:",
"    post:",
"      operationId: db_recent",
"      summary: Read recent rows from product_cache or wholesale_products",
"      requestBody:",
"        required: false",
"        content:",
"          application/json:",
...
"      summary: Read recent wholesale product rows from local SQLite DB",
"      requestBody:",
"        required: false",
"        content:",
"          application/json:",
...
"            application/json:",
"              schema: { $ref: '#/components/schemas/GenericObject' }",
"  /bulk_asin_offer_check:",
"    post:",
"      operationId: bulk_asin_offer_check",
"      summary: Bulk ASIN search and offer check by product titles",
"      requestBody:",
"        required: true",
"        content:",
"          application/json:",
...
"  /bulk_profit_check:",
"    post:",
"      operationId: bulk_profit_check",
"      summary: Analyze recent wholesale products across Amazon marketplaces and calculate profit",
"      requestBody:",
"        required: false",
"        content:",
"          application/json:",
...
app.all("/spapi_fees_estimate", requireAction, forwardToTarget);
...
app.all("/keepa_multi_market", requireAction, forwardToTarget);
app.all("/keepa_save_analysis", requireAction, forwardToTarget);
